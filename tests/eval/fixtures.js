...
const CASES = [
  ...
  },
  {
    ...
    pages: [[
      [L, 780, 'KWITANSI'],
      [L, 750, 'PT BINTANG RITEL NUSANTARA TBK'],
    ...
    expect: {
      ...
      counterparty_name: 'PT BINTANG RITEL NUSANTARA TBK', counterparty_npwp: null,
  ...
  },
  {
    ...
    pages: [[
      ...
      [L, 700, 'Ke : 075-4417805 / PT MITRA SELARAS UTAMA'],
    ...
    expect: {
      ...
      counterparty_name: 'PT MITRA SELARAS UTAMA', counterparty_npwp: null,
     ...
     at all, and could only ever prove that nothing can be read from nothing. */
  {
    ...
    raw: scannedPdf([[
      ...
      { rule: true },
      { text: 'NO: BRN/Z001/K-P/26/VIII/0177', scale: 3 },
      { gap: 24 },
      ...
      { text: 'REF TC-2411-0865', scale: 3 },
      { gap: 40 },
      { text: 'JAKARTA, 04 AGUSTUS 2026', scale: 3 },
      { gap: 30 },
      { text: 'PT BINTANG RITEL NUSANTARA TBK', scale: 3 },
    ]]),
    expect: {
      document_type: ['receipt', 'kwitansi'], document_number: 'BRN/Z001/K-P/26/VIII/0177',
      counterparty_name: 'PT BINTANG RITEL NUSANTARA TBK', counterparty_npwp: null,
      document_date: '2026-08-04', due_date: null,
      dpp: null, ppn: null, total: 11322000,
      direction: 'not_payable', must_not_create_record: true,
  ...
  },
  {
    ...
    raw: scannedPdf([[
      ...
      { text: '04002600300455129', scale: 3 },
      { gap: 24 },
      { text: 'PENGUSAHA KENA PAJAK', scale: 2 },
      { text: 'PT BINTANG RITEL NUSANTARA TBK', scale: 3 },
      { text: 'NPWP: 06.778.899.1-062.000', scale: 3 },
      { gap: 20 },
    ...
    expect: {
      document_type: ['faktur_pajak'], document_number: '04002600300455129',
      counterparty_name: 'PT BINTANG RITEL NUSANTARA TBK',
      counterparty_npwp: '06.778.899.1-062.000',
      document_date: '2026-08-04', due_date: null,
...
const BUNDLE_CASE = {
  ...
  expect: {
    is_bundle: true,
    document_count: 3,
    identifiers: ['BRN/Z001/K-P/26/VIII/0177', '04002600300455129', 'TC-2411-0865'],
  ...
  raw: scannedPdf([
    [
      ...
      { text: 'PT HELM CARE INDONESIA', scale: 4 },
      { text: 'RP 11.322.000', scale: 5 },
      { text: 'UNTUK SEWA TEMPAT REF TC-2411-0865', scale: 3 },
      { gap: 30 },
      { text: 'PT BINTANG RITEL NUSANTARA TBK', scale: 3 },
      { text: 'JAKARTA, 04 AGUSTUS 2026', scale: 3 },
    ],
    ...
    [
      ...
      { rule: true },
      { text: 'NOMOR: TC-2411-0865', scale: 3 },
      { gap: 24 },
