...
export default function Accounts() {
  ...
  const handleSave = async () => {
    ...
    try {
      if (editAccount) {
        // Rename: update all transactions with this source
        ...
        // Add new account with opening balance
      ...
      {showAdd && (
        <div onClick={() => setShowAdd(false)} style={{
          ...
          <div onClick={e => e.stopPropagation()} style={{
            ...
            <div style={{ marginBottom: editAccount ? 20 : 12 }}>
            ...
            {editAccount && (
              <div style={{ marginBottom: 20, background: 'var(--bg-2)', borderRadius: 10, padding: '10px 12px' }}>
